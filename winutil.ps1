...
"@
	...
	try {
		...
		reg add "HKLM\zSYSTEM\Setup\LabConfig" /v "BypassDiskCheck" /t REG_DWORD /d 1 /f
  ...
  "WPFTweaksRemoveOnedrive": {
    ...
    "InvokeScript": [
      "
        ...
        Start-Process -FilePath winget -ArgumentList \"uninstall -e --force --silent Microsoft.OneDrive \" -NoNewWindow -Wait
